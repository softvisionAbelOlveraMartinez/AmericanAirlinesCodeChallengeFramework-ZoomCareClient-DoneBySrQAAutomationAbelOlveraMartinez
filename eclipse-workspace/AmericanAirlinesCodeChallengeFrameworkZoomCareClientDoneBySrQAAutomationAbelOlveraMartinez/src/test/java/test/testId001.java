...
public class testId001 {
	//Initialize the Chrome Driver
	private static WebDriver driver= null;

	public static void main(String[] args) {

		//Executing TestCaseId001
		TestCaseId001();
	}



	public static void TestCaseId001() {
		...
		americanAirlinesHomePageObjects americanAirlinesHomePageObjects=new americanAirlinesHomePageObjects(driver); {
			...
			americanAirlinesHomePageObjects.albertaProvinceDropdownOptionTextAssertionResult(driver);
			//Click on Alberta Province Dropdown Option Web Element
			americanAirlinesHomePageObjects.clickOnAlbertaProvinceDropdownOption(driver);
			//Verify the text of YYC airport code with an Assertion
			americanAirlinesHomePageObjects.yycAirportCodeTextAssertionResult(driver);
			//Click on YYC airport code Web Element
			americanAirlinesHomePageObjects.clickOnYycAirportCode(driver);
			...
			americanAirlinesChooseFlightsPageObjects.getOutOfSearchLabelTextAssertionResultAlberta(driver);
		}
