...
public class testId002 {
	//Initialize the Chrome Driver
	private static WebDriver driver= null;

	public static void main(String[] args) {

		//Executing TestCaseId002
		TestCaseId002();
	}



	public static void TestCaseId002() {
		...
		americanAirlinesHomePageObjects americanAirlinesHomePageObjects=new americanAirlinesHomePageObjects(driver); {
			...
			System.out.println("\nTest Case Id: 002"
					...
					+ "\n* State/Province: Columbia Británica"
					+ "\n* City: Abbotsford"
					+ "\n* Airport: Abbotsford"
					+ "\n* airport code: YXX"
					+ "\ncorrectly.");
			...
			americanAirlinesHomePageObjects.columbiaBritanicaProvinceDropdownOptionTextAssertionResult(driver);
			//Click on Columbia Británica Province Dropdown Option Web Element
			americanAirlinesHomePageObjects.clickOnColumbiaBritanicaProvinceDropdownOption(driver);
			//Verify the text of YXX airport code with an Assertion
			americanAirlinesHomePageObjects.yxxAirportCodeTextAssertionResult(driver);
			//Click on YXX airport code Web Element
			americanAirlinesHomePageObjects.clickOnYxxAirportCode(driver);
