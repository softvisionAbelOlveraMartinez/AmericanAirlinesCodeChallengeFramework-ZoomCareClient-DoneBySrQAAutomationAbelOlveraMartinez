...
public class testId003 {
	//Initialize the Chrome Driver
	private static WebDriver driver= null;

	public static void main(String[] args) {

		//Executing TestCaseId003
		TestCaseId003();
	}



	public static void TestCaseId003() {
		...
		americanAirlinesHomePageObjects americanAirlinesHomePageObjects=new americanAirlinesHomePageObjects(driver); {
			...
			System.out.println("\nTest Case Id: 003"
					...
					+ "\n* State/Province: Territorios del Noroeste"
					+ "\n* City: Aklavik"
					+ "\n* Airport: Aklavik"
					+ "\n* airport code: LAK"
					+ "\ncorrectly.");
			...
			americanAirlinesHomePageObjects.territoriosDelNoroesteProvinceDropdownOptionTextAssertionResult(driver);
			//Click on Territorios del Noroeste Province Dropdown Option Web Element
			americanAirlinesHomePageObjects.clickOnTerritoriosDelNoroesteProvinceDropdownOption(driver);
			//Verify the text of LAK airport code with an Assertion
			americanAirlinesHomePageObjects.lakAirportCodeTextAssertionResult(driver);
			//Click on LAK airport code Web Element
			americanAirlinesHomePageObjects.clickOnLakAirportCode(driver);
			...
			americanAirlinesChooseFlightsPageObjects.getOutOfSearchLabelTextAssertionResultTerritoriosDelNoroeste(driver);
		}
