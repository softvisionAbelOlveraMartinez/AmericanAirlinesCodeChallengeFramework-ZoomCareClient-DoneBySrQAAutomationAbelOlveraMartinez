...
public class testId004 {
	//Initialize the Chrome Driver
	private static WebDriver driver= null;

	public static void main(String[] args) {

		//Executing TestCaseId004
		TestCaseId004();
	}



	public static void TestCaseId004() {
		...
		americanAirlinesHomePageObjects americanAirlinesHomePageObjects=new americanAirlinesHomePageObjects(driver); {
			...
			americanAirlinesHomePageObjects.ontarioProvinceDropdownOptionTextAssertionResult(driver);
			//Click on Ontario Province Dropdown Option Web Element
			americanAirlinesHomePageObjects.clickOnOntarioProvinceDropdownOption(driver);
			//Verify the text of YAX airport code with an Assertion
			americanAirlinesHomePageObjects.yaxAirportCodeTextAssertionResult(driver);
			//Click on YAX airport code Web Element
			americanAirlinesHomePageObjects.clickOnYaxAirportCode(driver);
