...
public class testId005 {
	//Initialize the Chrome Driver
	private static WebDriver driver= null;

	public static void main(String[] args) {

		//Executing TestCaseId005
		TestCaseId005();
	}



	public static void TestCaseId005() {
		...
		americanAirlinesHomePageObjects americanAirlinesHomePageObjects=new americanAirlinesHomePageObjects(driver); {
			...
			americanAirlinesHomePageObjects.manitobaProvinceDropdownOptionTextAssertionResult(driver);
			//Click on Manitoba Province Dropdown Option Web Element
			americanAirlinesHomePageObjects.clickOnManitobaProvinceDropdownOption(driver);
			//Verify the text of YBV airport code with an Assertion
			americanAirlinesHomePageObjects.ybvAirportCodeTextAssertionResult(driver);
			//Click on YBV airport code Web Element
			americanAirlinesHomePageObjects.clickOnYbvAirportCode(driver);
