...
public class testId006 {
	//Initialize the Chrome Driver
	private static WebDriver driver= null;

	public static void main(String[] args) {

		//Executing TestCaseId006
		TestCaseId006();
	}



	public static void TestCaseId006() {
		...
		americanAirlinesHomePageObjects americanAirlinesHomePageObjects=new americanAirlinesHomePageObjects(driver); {
			...
			System.out.println("\nTest Case Id: 006"
					...
					+ "\n* State/Province: Isla del Príncipe Eduardo"
					+ "\n* City: Charlottetown"
			...
			americanAirlinesHomePageObjects.islaDelPrincipeEduardoProvinceDropdownOptionTextAssertionResult(driver);
			//Click on Isla del Príncipe Eduardo Province Dropdown Option Web Element
			americanAirlinesHomePageObjects.clickOnIslaDelPrincipeEduardoProvinceDropdownOption(driver);
			//Verify the text of YYG airport code with an Assertion
			americanAirlinesHomePageObjects.yygAirportCodeTextAssertionResult(driver);
			//Click on YYG airport code Web Element
			americanAirlinesHomePageObjects.clickOnYygAirportCode(driver);
