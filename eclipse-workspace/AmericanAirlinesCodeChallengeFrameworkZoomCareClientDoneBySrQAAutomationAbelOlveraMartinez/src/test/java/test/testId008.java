...
public class testId008 {
	//Initialize the Chrome Driver
	private static WebDriver driver= null;

	public static void main(String[] args) {

		//Executing TestCaseId008
		TestCaseId008();
	}



	public static void TestCaseId008() {
		...
		americanAirlinesHomePageObjects americanAirlinesHomePageObjects=new americanAirlinesHomePageObjects(driver); {
			...
			System.out.println("\nTest Case Id: 008"
					...
					+ "\n* State/Province: Territorio Nunavut"
					+ "\n* City: Arviat"
					+ "\n* Airport: Arviat"
					+ "\n* airport code: YEK"
					+ "\ncorrectly.");
			...
			americanAirlinesHomePageObjects.territorioNunavutProvinceDropdownOptionTextAssertionResult(driver);
			//Click on Territorio Nunavut Province Dropdown Option Web Element
			americanAirlinesHomePageObjects.clickOnTerritorioNunavutProvinceDropdownOption(driver);
			//Verify the text of YEK airport code with an Assertion
			americanAirlinesHomePageObjects.yekAirportCodeTextAssertionResult(driver);
			//Click on YEK airport code Web Element
			americanAirlinesHomePageObjects.clickOnYekAirportCode(driver);
